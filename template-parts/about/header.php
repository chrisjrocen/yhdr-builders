...
<section class="page-header">
    <div class="container">
        ...
        <div class="page-header__intro">
            ...
            <?php else : ?>
            <p><?php esc_html_e('We design your ideas, we build them -- this is where cheap meets class.', 'yhdr'); ?>
            </p>
            <?php endif; ?>
        </div>
    </div>
    <?php yhdr_wave_divider('up', 'wave-divider--how-top', 'wave-divider--grey', 'wave-divider--bg-navy-mid'); ?>
</section>