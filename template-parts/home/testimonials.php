	...
	<div class="container">
		...
		<div class="testimonial-carousel">
			...
			<div class="testimonial-carousel__controls">
				<button type="button" class="testimonial-carousel__btn testimonial-carousel__btn--prev" aria-label="<?php esc_attr_e( 'Previous testimonial', 'yhdr' ); ?>">&larr;</button>
				<button type="button" class="testimonial-carousel__btn testimonial-carousel__btn--next" aria-label="<?php esc_attr_e( 'Next testimonial', 'yhdr' ); ?>">&rarr;</button>
			</div>
		</div>

		<?php if ( $archive_link ) : ?>
			<div class="testimonials__cta">
				<a href="<?php echo esc_url( $archive_link ); ?>"><?php esc_html_e( 'Read more client stories', 'yhdr' ); ?> &rarr;</a>
			</div>
		<?php endif; ?>
	</div>
</section>
