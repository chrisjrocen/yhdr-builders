	...
	<main id="yhdr-single-plan">
		...
		<div class="container single-plan__overview">
			...
			<div class="single-plan__body" data-animate="fadeIn" data-animate-delay="200ms">
				<div class="single-plan__badges">
					<?php if ( $type_term ) : ?><span class="badge"><?php echo esc_html( $type_term->name ); ?></span><?php endif; ?>
					<?php if ( $badge ) : ?><span class="badge-gold"><?php echo esc_html( $badge ); ?></span><?php endif; ?>
					<?php if ( $sku ) : ?><span class="single-plan__sku"><?php echo esc_html( sprintf( __( 'Plan %s', 'yhdr' ), $sku ) ); ?></span><?php endif; ?>
				</div>
				...
				<div class="single-plan__price">
					...
					<span class="single-plan__price-caption"><?php esc_html_e( 'full plan set · one-time payment', 'yhdr' ); ?></span>
				</div>
					...
					<div class="single-plan__specs">
						<?php foreach ( yhdr_plan_spec_pills( $product ) as $pill ) : ?>
							<div class="single-plan__spec">
								<span class="single-plan__spec-icon" aria-hidden="true"><?php echo esc_html( $pill['icon'] ); ?></span>
				...
				<div class="single-plan__actions">
					...
					<a href="<?php echo esc_url( yhdr_whatsapp_url( $whatsapp_base_message ) ); ?>"
						id="yhdr-whatsapp-buy-link"
						data-base-message="<?php echo esc_attr( $whatsapp_base_message ); ?>"
						class="btn btn-whatsapp-outline" target="_blank" rel="noopener noreferrer">
		...
		<div class="container single-plan__how">
			<div class="single-plan__included card">
				...
				<ul>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( 'Full architectural drawings', 'yhdr' ); ?></li>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( 'Structural drawings', 'yhdr' ); ?></li>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( 'Electrical and plumbing layouts', 'yhdr' ); ?></li>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( 'Bill of quantities (BOQ)', 'yhdr' ); ?></li>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( '3D renders', 'yhdr' ); ?></li>
					<li><span class="single-plan__check" aria-hidden="true">&check;</span><?php esc_html_e( 'One free revision consultation', 'yhdr' ); ?></li>
				</ul>
			</div>
			...
			<section class="shop shop--related">
				<div class="container">
					<div class="shop--related__header">
						...
						<?php if ( $shop_url ) : ?>
							<a href="<?php echo esc_url( $shop_url ); ?>" class="shop--related__all"><?php esc_html_e( 'All plans', 'yhdr' ); ?> &rarr;</a>
						<?php endif; ?>
					</div>
