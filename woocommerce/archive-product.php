...
<main id="yhdr-shop-archive">
	<section class="page-header">
		<div class="container">
			...
			<div class="page-header__intro">
				<p><?php esc_html_e( 'Every plan includes full architectural drawings, a bill of quantities and 3D renders -- ready to hand straight to a contractor, or build with us.', 'yhdr' ); ?></p>
			</div>
		</div>
		...
		<div class="container">
			<?php if ( $has_categories ) : ?>
				<div class="shop__filters" role="group" aria-label="<?php esc_attr_e( 'Filter plans by type', 'yhdr' ); ?>">
					<a href="<?php echo esc_url( $shop_url ); ?>" class="shop__filter-btn<?php echo ! $current_term ? ' is-active' : ''; ?>">
	...
	<section class="shop-how">
		<?php yhdr_wave_divider( 'down', 'wave-divider--shop-how-top', 'wave-divider--bg-navy-dark', 'wave-divider--bg-grey' ); ?>
		<div class="container">
		...
		<?php yhdr_wave_divider( 'up', 'wave-divider--shop-how-bottom', 'wave-divider--navy-dark', 'wave-divider--bg-grey' ); ?>
	</section>

	<section class="shop-cta">
		<div class="container">
			<h2><?php esc_html_e( "Don't See Your Dream Here?", 'yhdr' ); ?></h2>
			<p><?php esc_html_e( 'We design fully custom homes too -- tell us what you have in mind and our architects will take it from there.', 'yhdr' ); ?></p>
